                ...
                case 1: {
                    ...
                    if (escolhaIncluir.equals("F")) {
                        ...
                        try {
                            ...
                            System.out.println("Error de cadastro PF: " + e.getMessage());
                        }
                    }
                        ...
                        System.out.println("Dados PJ Cadastrados com sucesso");
                    }
                    else {
                    ...
                    if (escolhaAlterar.equals("F")) {
                        try {
                            ...
                            if (pf != null) {
                                ...
                                pfDao.alterar(pf);
                                System.out.println("Dados PF ALTERADOS com sucesso!");
                            }
                            else {
                        ...
                        try {
                            ...
                            if (pj != null) {
                                ...
                                try {
                                    pjDao.alterar(pj);
                                    System.out.println("Dados PJ ALTERADOS com sucesso");
